...
export interface ApiSpeakerSpeaker extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contact_linkedin: Schema.Attribute.String;
    ...
    summit_sessions: Schema.Attribute.Relation<
      'manyToMany',
      'api::summit-session.summit-session'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSummitSessionSummitSession
  extends Struct.CollectionTypeSchema {
  collectionName: 'summit_sessions';
  info: {
    displayName: 'Summit Session';
    pluralName: 'summit-sessions';
    singularName: 'summit-session';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    detail_images: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    end_time: Schema.Attribute.DateTime & Schema.Attribute.Required;
    event_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    external_id: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiTicketInfoTicketInfo extends Struct.CollectionTypeSchema {
  collectionName: 'ticket_infos';
  info: {
    displayName: 'Ticket Info';
    pluralName: 'ticket-infos';
    singularName: 'ticket-info';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    calendar_end_time: Schema.Attribute.DateTime;
    calendar_start_time: Schema.Attribute.DateTime;
    calendar_title: Schema.Attribute.String;
    contact_subtext_1: Schema.Attribute.String;
    contact_subtext_2: Schema.Attribute.String;
    contact_title: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_cta_label: Schema.Attribute.String;
    date_subtext_1: Schema.Attribute.String;
    date_subtext_2: Schema.Attribute.String;
    date_title: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ticket-info.ticket-info'
    > &
      Schema.Attribute.Private;
    location_cta_label: Schema.Attribute.String;
    location_query: Schema.Attribute.String;
    location_subtext_1: Schema.Attribute.String;
    location_subtext_2: Schema.Attribute.String;
...
export interface ApiVenueInfoVenueInfo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wifi_name: Schema.Attribute.String;
    wifi_password: Schema.Attribute.String;
  };
}
